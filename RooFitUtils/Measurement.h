...
public:
  ...
  Measurement(const std::string &MeasurementName = "",
  ...
  void SetCorrelationFactors(
      const std::map<std::string, std::pair<TString, TMatrixDSym>> &Factors) {
  ...
  void SetBinnedLikelihood(bool BinnedLikelihood) {
