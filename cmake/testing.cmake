...
foreach(TestScript ${TestScripts})
  ...
  if( ATLAS_BUILD )
    atlas_add_test(NAME ${TestName} WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} SCRIPT ${TestScript})
  else()
...
foreach(Test ${PythonTests})
  ...
  if( ATLAS_BUILD )
    atlas_add_test(NAME ${TestName} WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR} SCRIPT ${Test})
  else()
