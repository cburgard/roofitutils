...
if __name__ == "__main__":
    ...
    arglist.append(parser.add_argument('--findSigma',                     dest='findSigma', action='store_true' , help="Search for crossings to identify the 1-sigma-band.", default=False ))
    ...
    arglist.append(parser.add_argument('--minos',                     dest='minos', action='store_true' , help="Run Minos to identify the 1-sigma-band.", default=True ))
    arglist.append(parser.add_argument('--no-minos',                  dest='minos', action='store_false', help="Do not run minos.", default=False ))    
    ...
    arglist.append(parser.add_argument( "--print", action='store_true',   dest="printResult",help="option to print the fit result", default=True ))
    arglist.append(parser.add_argument( "--no-print", action='store_false',   dest="printResult",help="option to print the fit result"))        
