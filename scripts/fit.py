...
if __name__ == "__main__":
    ...
    arglist.append(basic.add_argument( "--randomize"     , type=str,     dest="randomizeParameters"            , help="Parameters to randomize.", nargs="+", metavar="POI", default=[]))    
    ...
    arglist.append(roofit.add_argument( "--initial-error", "--initError"     ,   dest="setInitialError"            , help="Pre-set the initial error.", action="store_true", default=False ))
    arglist.append(roofit.add_argument( "--no-initial-error",    dest="setInitialError"            , help="Do not pre-set the initial error.", action="store_false" ))    
    ...
    arglist.append(multi.add_argument( "--refine-scan-thresholds", type=float,     dest="refineScanThresholds", help="Likelihood thresholds to use to refine previous scan.", default=[68.,95.],nargs="+"))
